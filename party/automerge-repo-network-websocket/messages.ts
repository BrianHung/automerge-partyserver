...
export const isJoinMessage = (message: FromClientMessage): message is JoinMessage => message.type === 'join';

export const isLeaveMessage = (message: FromClientMessage): message is LeaveMessage => message.type === 'leave';

export const isPeerMessage = (message: FromServerMessage): message is PeerMessage => message.type === 'peer';

export const isErrorMessage = (message: FromServerMessage): message is ErrorMessage => message.type === 'error';
